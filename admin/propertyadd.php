...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO berita (title, pcontent, location, city, state, pimage, pimage1, pimage2, pimage3, pimage4, uid)
            VALUES ('$title', '$content', '$loc', '$city', '$state', '$aimage', '$aimage1', '$aimage2', '$aimage3', '$aimage4', '$uid')";
